...
const WorkStatus = () => {
  ...
  const [count_작업시작, setCount_작업시작] = useState(3);
  const [count_작업완료, setCount_작업완료] = useState(13);
      ...
      <RowView className="top">
        ...
        <ContentArea>
          ...
          <FilterBox>
            ...
            <span>▶︎</span>
            <div className={isSelect("작업시작")} onClick={setting_작업시작}>
              작업시작({count_작업시작})
            </div>
            <span>▶︎</span>
            <div className={isSelect("작업완료")} onClick={setting_작업완료}>
              작업완료({count_작업완료})
            </div>
          </FilterBox>
