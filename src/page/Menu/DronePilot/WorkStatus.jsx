...
const WorkStatus = () => {
  ...
  const setting_작업완료 = () => setFilter("작업완료");
    ...
    const filterData = (data) => {
      ...
      if (filter === 1) {
        return data.filter(exterminateSate => exterminateSate === 1);
      } else if (filter === 2) {
        return data.filter(exterminateSate => exterminateSate === 2);
        }
        else if (filter === 3) {
          return data.filter(exterminateSate => exterminateSate === 3);
        }
        else {
          return data;
        }
